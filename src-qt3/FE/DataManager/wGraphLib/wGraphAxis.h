...
class WGraphAxisLabel : public QWidget {
 ...
 public:
  ...
  WGraphAxisLabel(QWidget *parent, Orientation orient, const QString& label);
...
class WGraphAxis : public QWidget {
  ...
  */
  ...
  QMemArray<int> &getTickArray() { return tickPosArray; };
  ...
  QPopupMenu *getPopupMenu() { return popupMenu; }
 ...
 protected slots:
  ...
  void toggleAutoScale() { setAutoScale(!isAutoScale()); }
  void toggleExpandOnly() { expandOnly=!expandOnly; }
  void prepPopup();
 ...
 protected:
  ...
  QMemArray<int> tickPosArray;
  QMemArray<float> tickValArray;
