...
void ClsList::setData( vector<tiPoint> _lst){
#ifdef DEBUG_CLSSUBPOPULATIONS 
    cout << "ClsList::setData( vector<tiPoint> _lst)" << endl;
#endif                         
    lst = _lst;
};
    
vector<tiPoint> ClsList::getData() {
#ifdef DEBUG_CLSSUBPOPULATIONS 
...
void ClsTuples::addData(tListOfPoints lstSource, tListOfPoints lstTarget) {
    pair<tListOfPoints, tListOfPoints>  pT(lstSource, lstTarget);
    lstTuples.push_back(pT);
};
    
list<pair<tListOfPoints, tListOfPoints> > ClsTuples::getData() {
#ifdef DEBUG_CLSSUBPOPULATIONS 
...
void ClsTuples::setData(list<pair<tListOfPoints, tListOfPoints> > _lst){
    lstTuples = _lst;
}
...
#endif                         
    tListOfPoints lstOPSource;
    tListOfPoints lstOPTarget;
...
//		cout << "!strNodeName.compare(ClsTagLibrary::TargetList())" << endl;
    ...
    pair<tListOfPoints, tListOfPoints> pairLOP(lstOPSource, lstOPTarget);
