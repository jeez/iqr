 ...
 **
 ** $CreateDate: Tue Oct 23 17:34:58 2001
 ** $Date$
 **
 ** $Keywords:
...
namespace iqrcommon {
	...
	// @@@ 05/02/02 [jmb] Square geometry renamed regular, sparse
	// renamed custom.  Hexagonal removed, can be added via a
	// predefined custom type in the interface.
...
//--	static const char* LinearThresholdNeuronTag() {
//--	    return "NeuronLinearThreshold";
//--	}
//--	static const char* IntegrateFireNeuronTag() {
//--	    return "NeuronIntegrateFire";
//--	}
//--	static const char* RandomSpikeNeuronTag() {
//--	    return "NeuronRandomSpike";
//--	}
//--	static const char* SigmoidNeuronTag() {
//--	    return "NeuronSigmoid";
//--	}
//--	static const char* TanhNeuronTag() {
//--	    return "NeuronTanH";
//--	}
...
//--	static const char* SubConnectionTag() {
