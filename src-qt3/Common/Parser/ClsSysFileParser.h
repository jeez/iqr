...
//--	ClsInfoDiagramLine getClipboardDiagramLine(string strID);
//--	ClsInfoDiagramIcon getDiagramIcon(string strID);
//--	ClsInfoDiagramIcon getClipboardDiagramIcon(string strID);
	...
	// getNote* for consistency with system file/tag library.
...
//--	ClsInfoDiagramIcon getDiagramIcon_OLD(string strID, DOMDocument* ddocRoot);
//--	ClsInfoDiagramLine getDiagramLine_OLD(string strID, DOMDocument* ddocRoot);
