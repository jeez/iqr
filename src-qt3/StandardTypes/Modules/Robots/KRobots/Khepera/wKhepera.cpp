...
WKhepera::WKhepera(WModule *parent, const QString &name)  
  ...
  addParam(&deviceName,"device","/dev/ttyS0",this,&WKhepera::initDevice)
    ->list()=QStringList()<<"/dev/ttyS0"<<"/dev/ttyS1"<<"/dev/ttyS2"<<"/dev/ttyS3";
  
  addParam(&deviceSpeed,"bitrate",2,this,&WKhepera::initDevice)
  ...
  pidVal=pidNode->addParam(&pidPropVal,"proportional",3800,
			   this,&WKhepera::setPIDMotorController);
  ...
  addAction(&WKhepera::initDevice,"initialize robot");
