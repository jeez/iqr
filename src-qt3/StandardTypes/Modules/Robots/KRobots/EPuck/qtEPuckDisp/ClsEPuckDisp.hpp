...
public:
    QCEventData( pair<double,double> _pData ) : QCustomEvent( 65433 ), pData(_pData) {
    }
...
class ClsEPuckDisp : public QWidget {
    Q_OBJECT
public:
    ClsEPuckDisp( const char *caption);
