#include "moduleBttvVideoColor.hpp"


#ifdef IQRMODULE
MAKE_MODULE_DLL_INTERFACE(iqrcommon::moduleBttvVideoColor,
			  "bttv video color module new")
...
#ifdef IQRMODULE
iqrcommon::moduleBttvVideoColor::moduleBttvVideoColor() : ClsBaseVideoItem() {
#else
    iqrcommon::moduleBttvVideoColor::moduleBttvVideoColor() {
#endif
...
//	iCounter = 0;
...
#ifdef IQRMODULE
    moduleIcon iqrcommon::moduleBttvVideoColor::getIcon() {
    ...
    void iqrcommon::moduleBttvVideoColor::init(){
	cout << "moduleBttvVideoColor::init()" << endl;
...
//	cout << "iGroupWidth, iGroupHeight: " << iGroupWidth << ", " << iGroupHeight << endl;
    ...
    void iqrcommon::moduleBttvVideoColor::openDevice(string strDeviceName) {
	cout << "moduleBttvVideoColor::openDevice(string strDeviceName)" << endl;
...
//  if (V4LSetSource(v4l, BigPictureCompositeSource, VIDEO_MODE_NTSC) < 0) {
    ...
    void iqrcommon::moduleBttvVideoColor::closeDevice() {
//	cout << "moduleBttvVideoColor::closeDevice(void)" << endl;
//	cout << "device_fd: " << device_fd << endl;
    ...
    void iqrcommon::moduleBttvVideoColor::setPictureProperties() {
    ...
    void iqrcommon::moduleBttvVideoColor::printDeviceInfo() {
...
//orig  	cout << "depth:          " << sVideo_picture.depth << endl;     
    ...
    void iqrcommon::moduleBttvVideoColor::update(){
//    cout << "moduleBttvVideoColor::update()" << endl;
...
//	  cout << "iY: " << iY << endl;
	    for(int iX=0; iX < imgWidth; iX++){
  		ir = (unsigned char)captureBuf[iPixel++];
  		ig = (unsigned char)captureBuf[iPixel++];
  		ib = (unsigned char)captureBuf[iPixel++];
...
//		    cout  << value << " ";
    ...
    void iqrcommon::moduleBttvVideoColor::cleanup(){
//	cout << "moduleBttvVideoColor::cleanup()" << endl;
	if(bShowOutput){
