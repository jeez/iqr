...
/////////////////////////////////////////////////////////
    ...
    if(iRoundCounter==1){
	gettimeofday(&sTimeval, &sTimezone);
	fStartTime = sTimeval.tv_sec + (double)sTimeval.tv_usec/1000000.;
    }
/////////////////////////////////////////////////////////
...
#define NEW_SUBSAMPLING
		...
		clsStateArrayOut[0][iCoord ] += (double)(iGrayPixel) / ( 256.) + SHIFT; 
#endif
#endif
	    }
...
/////////////////////////////////////////////////////////
    ...
    gettimeofday(&sTimeval, &sTimezone);
    fCurrentTime = sTimeval.tv_sec + (double)sTimeval.tv_usec/1e6;
