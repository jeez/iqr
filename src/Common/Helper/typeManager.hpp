 ...
 ** $Author$
 ** 
 ** Created: Thu Dec 06 2001 12:02:48
 ** Time-stamp: <Sat Oct 18 2003 17:14:17 Mark Blanchard>
 **
 ** $Date$
 **
 ** $Description$
...
namespace iqrcommon {
	...
	try {
	    ...
	    charFn* pLabelFn = 
		(charFn*)typeLoader.getSymbol(_strFileName, _strLabelSymbol);
	    CreateFn* pCreate =
		(CreateFn*)typeLoader.getSymbol(_strFileName, _strCreateSymbol);
	    DestroyFn* pDestroy =
		(DestroyFn*)typeLoader.getSymbol(_strFileName, _strDestroySymbol);
