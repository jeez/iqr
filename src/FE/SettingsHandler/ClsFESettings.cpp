 ...
 ** $Author$
 **
 ** Created: Wed Dec 11 12:06:24 2002
 ** Time-stamp: <Fri Mar 28 2003 23:19:43 Mark Blanchard>
 **
 ** $Date$
 **
 ** $Description$
...
iqrfe::ClsFESettings::ClsFESettings() {
    ...
    strSettingsFile = strHome + "/.iqrSettings";
...
void iqrfe::ClsFESettings::setDefaultSettings() {
    ...
    string strStandardPath(addDirectorySeparator("/opt/iqr/lib/"));
...
/* ------------------- */
    ...
    string strLocalPath(addDirectorySeparator("/usr/lib/iqr/"));
...
/* =================
   ...
   CHANGED: THEREFOR WE WILL ENFORCE THE NEW PATH
    string strLocalModulePath  = clsSettingsReader.getEntity(ClsTagLibrary::LocalModulePath());
    string strLocalNeuronPath  = clsSettingsReader.getEntity(ClsTagLibrary::LocalNeuronPath());
    string strLocalSynapsePath = clsSettingsReader.getEntity(ClsTagLibrary::LocalSynapsePath());
*/

    string strLocalModulePath  = "/usr/lib/iqr/Modules"; // clsSettingsReader.getEntity(ClsTagLibrary::LocalModulePath());
    string strLocalNeuronPath  = "/usr/lib/iqr/Neurons"; // clsSettingsReader.getEntity(ClsTagLibrary::LocalNeuronPath());
    string strLocalSynapsePath = "/usr/lib/iqr/Synapses"; // clsSettingsReader.getEntity(ClsTagLibrary::LocalSynapsePath());
/* ================ */
