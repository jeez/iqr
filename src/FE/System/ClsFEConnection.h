...
private:
    ...
    ListIndexQuadruples calculateArborization(const VectorPointTriples& vectorPointTriples, ClsBaseTopology *clsBaseTopologySource, ClsBaseTopology *clsBaseTopologyTarget); 
    void expandXXX(VectorPointTriples &vectorPointTriples, const tVectorOfPoints &tVectorOfPointsSource , const tVectorOfPoints &tVectorOfPointsTarget);

    ListIndexQuadruples PointTriples2IndexQuadruples(const VectorPointTriples& vectorPointTriples, ClsBaseTopology *clsBaseTopologySource, ClsBaseTopology *clsBaseTopologyTarget );
