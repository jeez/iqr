...
//#define DEBUG_CLSSYSTEMGUI



// ClsSystemGUI::ClsSystemGUI( QWidget* parent, const char* name, WFlags f) : iqrMainWindow( parent, name, f ) {
...
//// Local Variables:
//// mode: c++
//// compile-command: "cd /home/ulysses/Code/iqr421_Redesign/FE/IQR/ && make -k -j8"
//// End:
