...
ClsQHarborValueDialog::ClsQHarborValueDialog( QWidget* parent, 
     ...
     : QDialog( parent, "ClsQHarborValueDialog", true, Qt::WType_Dialog ), iItemType(_iItemType), strItemID(_strItemID), iIndex(_iIndex), strParamName(_strParamName)  {
    
   setCaption( tr( "Harbor:change value-" ) );


    setSizeGripEnabled( FALSE );
    setModal( TRUE );
    ClsQHarborValueDialogLayout = new QVBoxLayout( this, 11, 6, "ClsQHarborValueDialogLayout"); 

    layout5 = new QHBoxLayout( 0, 0, 6, "layout5"); 

    qlblParamName = new QLabel( this, "qlblParamName" );
    qlblParamName->setText(_strParamLabel);
