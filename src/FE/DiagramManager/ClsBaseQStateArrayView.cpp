...
void ClsBaseQStateArrayView::mouseHandle( const QPoint &_pos ) {
#ifdef DEBUG_CLSBASEQSTATEARRAYVIEW
    cout << "ClsBaseQStateArrayView::mouseHandle( const QPoint &_pos )" << endl;
#endif
...
void ClsBaseQStateArrayView::mouseHandleRegion( const QPoint &_pos ) {
#ifdef DEBUG_CLSBASEQSTATEARRAYVIEW
    cout << "ClsBaseQStateArrayView::mouseHandleRegion( const QPoint &_pos )" << endl;
#endif
...
#ifdef DEBUG_CLSBASEQSTATEARRAYVIEW
    cout << "ClsBaseQStateArrayView::markCell(int iColor, int iX, int iY)" << endl;
#endif
    QPainter paint(&pmGridEmpty);
    QPen qp;
    QColor qc;
    qc.setHsv(iColor, 255,255);
    qp.setColor(qc);
    qp.setWidth (1 );
    paint.setPen(qp);

//    paint.drawRect(index2pos2( iX ) - 1 -BORDER, index2pos2( iY ) -1 -BORDER, iCellSize +1, iCellSize +1);
////	paint.drawRect(index2pos2( iX ) - 1 -BORDER, index2pos2( iY ) -1 -BORDER, iCellSize +4, iCellSize +4);
//
