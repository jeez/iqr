...
//ZZZ    setBackgroundMode ( NoBackground);
...
//ZZZvoid ClsKhepDisp::ClearImg(){
//ZZZ    _buffer->fill(Qt::black );
//ZZZ    bitBlt (this, 0, 0, _buffer);
//ZZZ}

//ZZZvoid ClsKhepDisp::PassBack( int iPassBack ){
...
//ZZZvoid ClsKhepDisp::resizeEvent( QResizeEvent* event) {
...
void ClsKhepDisp::customEvent( QEvent* e ) {
//    cout << "ClsKhepDisp::customEvent( QEvent* e )" << endl;
