...
MAKE_MODULE_DLL_INTERFACE(iqrcommon::moduleUSBVideoQC,
			  "USB quickcam module")
#endif
...
#ifdef IQRMODULE
iqrcommon::moduleUSBVideoQC::moduleUSBVideoQC() : ClsModule() {
#else
    iqrcommon::moduleUSBVideoQC::moduleUSBVideoQC() {
#endif
...
#ifdef IQRMODULE
    moduleIcon iqrcommon::moduleUSBVideoQC::getIcon() {
//	moduleIcon mi(DSCP92_small_png_data, DSCP92_small_png_len, 3 ,5);
    ...
    void iqrcommon::moduleUSBVideoQC::init(){
	cout << "moduleUSBVideoQC::init()" << endl;
...
//	cout << "iGroupWidth, iGroupHeight: " << iGroupWidth << ", " << iGroupHeight << endl;
    ...
    void iqrcommon::moduleUSBVideoQC::openDevice(string strDeviceName) {
	errno = 0;
...
// 	}
    ...
    void iqrcommon::moduleUSBVideoQC::closeDevice() {
//	cout << "moduleUSBVideoQC::closeDevice(void)" << endl;
...
//TEMP	sleep(2);
    ...
    void iqrcommon::moduleUSBVideoQC::setPictureProperties() {
...
*/
    ...
    void iqrcommon::moduleUSBVideoQC::printDeviceInfo() {
...
*/
    ...
    int iqrcommon::moduleUSBVideoQC::mapMemory(void) {
    ...
    void iqrcommon::moduleUSBVideoQC::cleanup(){
//	cout << "moduleUSBVideoQC::cleanup()" << endl;
...
/* crash... */
    ...
    void iqrcommon::moduleUSBVideoQC::update(){
//    cout << "moduleUSBVideoQC::update()" << endl;
...
//	cout << "iVidbufSize: " << iVidbufSize << endl;
    ...
    void iqrcommon::moduleUSBVideoQC::writePPM(const char *filename) {
