...
MAKE_MODULE_DLL_INTERFACE(iqrcommon::moduleUSBVideoColor,
			  "USB video color module")
#endif
...
#ifdef IQRMODULE
iqrcommon::moduleUSBVideoColor::moduleUSBVideoColor() : ClsThreadModule() {
#else
    iqrcommon::moduleUSBVideoColor::moduleUSBVideoColor() {
#endif
...
#ifdef IQRMODULE
    moduleIcon iqrcommon::moduleUSBVideoColor::getIcon() {
//	moduleIcon mi(DSCP92_small_png_data, DSCP92_small_png_len, 3 ,5);
    ...
    void iqrcommon::moduleUSBVideoColor::init(){
	cout << "moduleUSBVideoColor::init()" << endl;
...
*/
	...
	if((clsStateVariableVideoOutputRed->getStateArray().getWidth() != clsStateVariableVideoOutputGreen->getStateArray().getWidth()) ||
	   (clsStateVariableVideoOutputRed->getStateArray().getWidth() != clsStateVariableVideoOutputBlue->getStateArray().getWidth())){
	    throw ModuleError(string("Module \"") + getLabel() + "\": All Video input groups must be of equal size");
	}
...
//	cout << "iGroupWidth, iGroupHeight: " << iGroupWidth << ", " << iGroupHeight << endl;
    ...
    void iqrcommon::moduleUSBVideoColor::openDevice(string strDeviceName) {
	errno = 0;
...
// 	}
    ...
    void iqrcommon::moduleUSBVideoColor::closeDevice() {
//	cout << "moduleUSBVideoColor::closeDevice(void)" << endl;
...
//TEMP	sleep(2);
    ...
    void iqrcommon::moduleUSBVideoColor::setPictureProperties() {
...
*/
    ...
    void iqrcommon::moduleUSBVideoColor::printDeviceInfo() {
...
*/	    
    ...
    int iqrcommon::moduleUSBVideoColor::mapMemory(void) {
    ...
    void iqrcommon::moduleUSBVideoColor::cleanup(){
//	cout << "moduleUSBVideoColor::cleanup()" << endl;
...
/* crash... */
    ...
    void iqrcommon::moduleUSBVideoColor::update(){
//    cout << "moduleUSBVideoColor::update()" << endl;
