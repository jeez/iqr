...
//--	    if (!name.toStdString().find(embed_image_vec[i].name)) {
...
//--				 QImage::BigEndian );*/
//--
//--//ZZZ FIX		img->convertToFormat(QImage::Format_Mono);
//--		
//--		img->setColorTable( QVector<QRgb>(1, (QRgb*)embed_image_vec[i].colorTable));
//--
//--		if ( embed_image_vec[i].alpha ){
//--//ZZZ FIX		    img->setAlphaBuffer( TRUE );
//--		}
