...
public:
  /*! Constructs a WGraphWidget with a horizontal axis at \em
    ...
    present. */
  WGraphWidget(QWidget *parent, WGraphXAxis::Position xAxisPos=WGraphXAxis::bottom,
  ...
  void setBackgroundColor(QColor color) { 
    QPalette palette;
    palette.setColor(drawingFrame->backgroundRole(), color);
    drawingFrame->setPalette(palette);
  };
  ...
  QMenu *gridPopup() const { return showGridPopup; }
...
signals:
 ...
 private:
  ...
  QAction *qactShowYGrid;
  QAction *qactShowXGrid;
