...
class WDoubleValidator : public QDoubleValidator {
 public:
  WDoubleValidator(QWidget *parent, const char *name=0) : QDoubleValidator(parent) {}
...
class WDoubleEdit : public QLineEdit {
  Q_OBJECT
public:
  WDoubleEdit(QWidget *parent, const char *name=0) : QLineEdit(parent) { 
...
//ZZZ      validateAndSet((const char*)QString::number(v,'g',5),0,0,0);
      emit valueChanged(v);
  }
