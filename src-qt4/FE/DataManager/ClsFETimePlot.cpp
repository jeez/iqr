...
//zzz	    dynamic_cast<ClsQNeuronStateVariableDisplay*>(tmp)->close();
//zzz	}
//zzz    }
...
//zzz	++iter;
//zzz	if((clsQNeuronStateVariableDisplay = dynamic_cast<ClsQNeuronStateVariableDisplay*>(tmp))){
//zzz	    ClsStateVariableDisplayConfig clsStateVariableDisplayConfig = clsQNeuronStateVariableDisplay->getConfig();
//zzz	    clsDataClientConfig.addStateVariableDisplayConfig(clsStateVariableDisplayConfig);
//zzz	}
//zzz    }
//zzz
    for(it=qObjectList.begin();it!=qObjectList.end();it++ ) {
...
//zzz	++iter;
//zzz	if((clsQNeuronStateVariableDisplay = dynamic_cast<ClsQNeuronStateVariableDisplay*>(tmp))){
//zzz	    if(!_strGroupID.compare(clsQNeuronStateVariableDisplay->getGroupID())){
//zzz		clsQNeuronStateVariableDisplay->groupChanged();
//zzz	    }
//zzz	}
//zzz    }
//zzz
