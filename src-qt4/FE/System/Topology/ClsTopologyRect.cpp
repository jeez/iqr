...
list<tiPoint > ClsTopologyRect::checkList(const list<tiPoint > &lstIn) {
    list<tiPoint > lst;
...
bool ClsTopologyRect::isValidIndex(list<tiPoint > _lst, int iGroupWidth, int iIndex) {
//    cout << "ClsTopologyRect::isValidIndex(list<tiPoint > _lst, int iGroupWidth, int iIndex)" << endl;
...
list<tiPoint > ClsTopologyRect::getPoints4Ellipse(double fXCenter, double fYCenter, double fWidth, double fHeight) {
    list<tiPoint > lst;
...
list<tiPoint > ClsTopologyRect::getPoints4Rect(double fXCenter, double fYCenter, double fWidth, double fHeight) {
...
list<tiPoint > ClsTopologyRect::getPoints4Rect(int iXStart, int iYStart, int iWidth, int iHeight) {
//    cout << "ClsTopologyRect::getPoints4Rect(int iXStart, int iYStart, int iWidth, int iHeight)" << endl;
	...
	for(int jj=iXStart; jj<iXStart+iWidth; jj++){
	    ...
	    lstPointsReturn.push_back(pairTemp);
	}
    }
    return lstPointsReturn;
}
...
list<tiPoint > ClsTopologyRect::getAllPoints(int iWidth, int iHeight) {
    list<tiPoint > lstPointsReturn;
