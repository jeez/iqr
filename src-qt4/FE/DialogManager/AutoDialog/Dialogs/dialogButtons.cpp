...
iqrfe::ClsModalButtons::ClsModalButtons(QWidget *_pqwgtParent)
	...
	cout << "ClsModalButtons::ClsModalButtons" << endl;
    }

    QHBoxLayout *pqlayButtons = new QHBoxLayout(this /*, BUTTON_BORDER, BUTTON_SPACE*/);
...
iqrfe::ClsModelessButtons::ClsModelessButtons(QWidget *_pqwgtParent /*ZZZ, const char *_pcName*/)
    : QWidget(_pqwgtParent /*ZZZ, _pcName*/) {
    if (bDebugDialogButtons) {
	cout << "ClsModelessButtons::ClsModelessButtons" << endl;
    }
 ...
 */
void iqrfe::ClsModelessButtons::enableApply() {
 ...
 */
void iqrfe::ClsModelessButtons::disableApply() {
 ...
 */
void iqrfe::ClsModelessButtons::enableUndo() {
 ...
 */
void iqrfe::ClsModelessButtons::disableUndo() {
    pqpbUndo->setEnabled(false);
}
 ...
 */
void iqrfe::ClsModelessButtons::showEvent(QShowEvent *e) {
