...
// void ClsQStateArrayViewHex::mouseHandle( const QPointF &pos ) {
...
// void ClsQStateArrayViewHex::mouseHandleRegion( const QPointF &pos ) {
//     cout << "ClsQStateArrayViewHex::mouseHandleRegion( const QPointF &pos )" << endl;
